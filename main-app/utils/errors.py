...
class ErrorHandler:
    ...
    ЕДИНСТВЕННЫЙ источник обработки ошибок
    """
    ...
    def handle_api_error(error: Exception, operation_name: str = "операция") -> bool:
        ...
        ErrorHandler._show_error_details(error, operation_name)
        return False
    ...
    def handle_file_error(error: Exception, file_name: str = "файл") -> bool:
        ...
        ErrorHandler._show_error_details(error, f"file_{file_name}")
        return False
    ...
    def handle_image_processing_error(error: Exception, operation_name: str = "обработка") -> bool:
        ...
        ErrorHandler._show_error_details(error, f"image_{operation_name}")
        return False
    ...
    def _show_error_details(error: Exception, key_suffix: str):
        ...
        Вынесен для избежания дублирования кода
        """
...
# Создаем singleton-экземпляр для удобства
