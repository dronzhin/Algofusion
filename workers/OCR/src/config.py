...
class Config:
    ...
    next_queue: str = field(default_factory=lambda: os.getenv("NEXT_QUEUE", "files:parser"))
    ...
    ocr_dpi: int = field(default_factory=lambda: int(os.getenv("OCR_DPI", "200")))
    ocr_engine: str = field(default_factory=lambda: os.getenv("OCR_ENGINE", "surya"))
    ocr_lang: str = field(default_factory=lambda: os.getenv("OCR_LANG", "rus+eng"))
