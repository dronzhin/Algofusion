...
from src.modules.layout import LayoutModule
...
class LayoutWorker:
    ...
    def process_job(self, payload: str) -> bool:
        ...
        job_logger.info("Layout processing started")
        ...
        if success:
            ...
            job_logger.info("Layout completed successfully")
        else:
            job_logger.error("Layout failed")
    ...
    def run(self) -> None:
        ...
        logger.info("Layout worker started, queue: %s", self.queue_name)
        error_count = 0
        ...
        logger.info("Layout worker stopped")
